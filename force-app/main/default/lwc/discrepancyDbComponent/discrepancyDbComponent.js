...
export default class DiscrepancyDbComponent extends LightningElement {
  ...
  //@track statuslistfiltervalue = [{ label: "All Defect Status", value: "All Defect Status" }, { label: "Open", value: "open" }, { label: "Resolved", value: "resolve" }, { label: "Verified", value: "approve" }];//workaround
  //@track selectedstatus = "All Defect Status"; //workaround
  ...
  @track selectedstatus = "Open"; //workaround
  ...
  loaddataforview(event) {
    ...
    //workaround ends
    //var statusparm = { bus_status: statuslist};//workaround
    var statusparm = { bus_status: statuslist, discrepancy_status: discstatuslist };//workaround
  ...
  handlediscrepancystatuschange(event) {
    ...
    //this.applyfilterchanges(event);//workaround
    this.loaddataforview();//workaround
  }
