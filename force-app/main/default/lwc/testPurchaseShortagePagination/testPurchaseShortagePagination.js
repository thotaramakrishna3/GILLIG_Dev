...
export default class TestPurchaseShortagePagination extends LightningElement {
    ...
    //  get disableeditshortage1() {
    //      return this.selectedstatus != "Open";
    //     //   return this.permissionset.shortage_update.write != true ||  this.selectedGroupshortage.discrepancy_statusdisplay != "Open"; 
    //  }
    ...
    updateselectedshortage(event) {
        ...
        if (event.target.type == "checkbox") {
            ...
            if (targetvalue) {
                // this.selectedshortage.ship_short_pco = "Your Default Ship Short PCO Value";
                ...
                // this.selectedshortage.ship_short_pco = null;
    ...
    if (!customSearchLookup || !customSearchLookup.selectedcustomer) {
        const alertmessage = new ShowToastEvent({
        ...
        if (allValid) {
            ...
            if (discrepancytobeupdated.buyer_code != null) {
                for (var item in this.buyerpicklist) {
                    if (this.buyerpicklist[item]['buyer'] == discrepancytobeupdated.buyer_code) {  // Sathish modified label
    ...
    applypaginationfilter(event){
        ...
        var statusparm = {
            ...
            // has_date_recieved: this.datereceivedfilter == false ? null : this.datereceivedfilter,
    ...
    //     // Abhishek added cause and vendor
    //   }
  ...
  highlightRow(event) {
    ...
    updategroupupdatestoServer(event){ 
            ...
            //  && this.selectedGroupshortage[key] !== ""
