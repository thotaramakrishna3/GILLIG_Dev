                    ...
                    if (data.isError) {
                        ...
                        if (response_msg == 'Date Conflict') {
                            ...
                            if(this.is_deactivated){
                                ...
                                this.showmessage('Assignment Updated.', 'The Crewing Assignment successfully updated.', 'success');
                                this.assignmentdetailmodal = false;
                            }                            
                        }
                        this.loadcrewadjustmentdata();
                        // this.showmessage('Assignment Updated.', 'The Crew Adjustment Assignment successfully updated.', 'success');
                        // this.assignmentdetailmodal = false;
                        // this.loadcrewadjustmentdata();
                    }
                }).catch(error => {
